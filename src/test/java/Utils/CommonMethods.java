...
public class CommonMethods extends PageInitializer {
    ...
    public static void openBrowserAndLaunchApplication() {
        ...
        initializePageObjects();  //this will initialize all the pages we have in our page
                                  //PageInitialiser class along with the launching of application
    ...
    public static byte[] takeScreenshot(String imageName) {
       ...
       // this is the webDriver instance 'driver' to TakeScreenshot Interface
        ...
        //This captures thr screenshot and stores it as a file in the sourceFile variable
